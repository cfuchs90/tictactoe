...
const Display = (function() {
  ...
  const newGameListener = function() {
  ...
  return { grid, getBoard, round, clear, score, newGameListener};
})()
...
let curGame = Controller.newGame()

Display.newGameListener();
// Display.round(curGame.turn)
